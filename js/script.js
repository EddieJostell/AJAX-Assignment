...
const newsMod = (() => {
  return {
    //First function that contains a template literal that is shown on the front page.
    getLatestNews: () => {
    ...
    getApiByArticles: (inputSrc) => {
      newsMod.fetchGetArticles(
        `https://newsapi.org/v1/articles?source=${inputSrc}&sortBy=top&apiKey=ba003866cd1849ffb405924244eb308e`
      );
    },
    getApiBySources: (inputCat) => {
      newsMod.fetchGetSources(
        `https://newsapi.org/v1/sources?category=${inputCat}&apiKey=ba003866cd1849ffb405924244eb308e`
      );
    },
    ...
    registerEventHandlers: () => {
      ...
      document
        ...
        .addEventListener('click', newsMod.getLatestNews);
      //General News
      document
        .getElementById('cnn')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('bbc-news')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('general')
        .addEventListener('click', newsMod.findSourceByCategory);
      //Business News
      document
        .getElementById('the-wall-street-journal')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('financial-times')
        .addEventListener('click', newsMod.findArticleById);
      document
      ...
      document
        ...
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('football-italia')
        .addEventListener('click', newsMod.findArticleById);
      document
      ...
      //Music News
      document
        .getElementById('mtv-news')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('mtv-news-uk')
        .addEventListener('click', newsMod.findArticleById);
      document
      ...
      //Entertainment News
      document
        .getElementById('entertainment-weekly')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('the-lad-bible')
        .addEventListener('click', newsMod.findArticleById);
      document
      ...
      document
        .getElementById('national-geographic')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('new-scientist')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('science-and-nature')
        .addEventListener('click', newsMod.findSourceByCategory);
      //Technology News
      document
        .getElementById('techcrunch')
        .addEventListener('click', newsMod.findArticleById);
      document
        .getElementById('the-verge')
        .addEventListener('click', newsMod.findArticleById);
      document
